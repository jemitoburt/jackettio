export default {
    ...
    // The passkey pattern
    replacePasskeyPattern:
        process.env.REPLACE_PASSKEY_PATTERN || "[a-zA-Z0-9]+",
    ...
    slowIndexerDuration:
        parseInt(process.env.SLOW_INDEXER_DURATION || 20) * 1000,
    ...
    defaultUserConfig: {
        ...
        forceCacheNextEpisode:
            (process.env.DEFAULT_FORCE_CACHE_NEXT_EPISODE || "false") ===
            "true",
        ...
        indexerTimeoutSec: parseInt(
            process.env.DEFAULT_INDEXER_TIMEOUT_SEC || "60"
        ),
        passkey: "",
        ...
        enableMediaFlow:
            (process.env.DEFAULT_ENABLE_MEDIA_FLOW || "false") === "true",
